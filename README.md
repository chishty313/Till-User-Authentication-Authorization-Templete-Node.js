...
## 1️⃣2️⃣ Email Utility (Mailgen + Nodemailer)

We’ll use [Nodemailer](https://nodemailer.com/) and [Mailgen](https://mailgen.js.org/) to send pretty emails (e.g., verification, password reset).
...
```
> 📧 Use sendEmail() with emailVerificationMailgenContent() or forgotPasswordMailgenContent() to send styled messages.
